...
def render_dashboard_home(df_todos: pd.DataFrame):
    ...
    with col_rosca:
        ...
        st.markdown(
            ...
            f"<span style='font-size:11px;color:#7a9cc7;'>Meta diária</span>"
            f"<span style='font-size:28px;font-weight:700;color:#c9d8f0;line-height:1;'>"
            f"{_leads_hoje} / {_meta_diaria}</span>"
            f"</div>"
